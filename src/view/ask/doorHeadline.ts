 ...
 * - **the shape of the run opened it.** Tools were bound and none were called,
 *   and nobody said why. That is a fact about *this run* and nothing more: the
 *   shape cannot tell a refusal from an answer the model simply knew. So the
 *   card claims exactly that much, in the past tense, and asks rather than
 *   asserts.
 *
