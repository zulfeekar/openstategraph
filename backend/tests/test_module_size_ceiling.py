...
2,039 code lines, then 1,944, 1,829, 1,750, 1,434, 1,343, 1,194, and now 1,040
with sixteen node families living in their own modules under `compile/nodes/`.
...
RECORDED: dict[str, Recorded] = {
    "compile/node_runtime.py": Recorded(1040, NODE_RUNTIME),
