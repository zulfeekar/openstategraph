...
2,039 code lines, then 1,944, 1,829, 1,750, 1,434, 1,343, 1,194, 1,040, and now
825 with seventeen node families living in their own modules under
`compile/nodes/`.
...
RECORDED: dict[str, Recorded] = {
    "compile/node_runtime.py": Recorded(825, NODE_RUNTIME),
