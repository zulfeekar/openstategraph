...
uv tool install \
  ...
  "openstategraph[server,ollama]==0.3.0rc13"
```
...
> **`0.3.0rc13` is the first pre-release that carries everything on this
...
110 files, 1.6 MB of a 4.73 MB wheel, and the browser payload with Mermaid is
58% of the download (regenerated by `scripts/measure_wheel_footprint.py`, whose
