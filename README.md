...
uv tool install \
  ...
  "openstategraph[server,ollama]==0.3.0rc12"
```
...
> **`0.3.0rc12` is the first pre-release that carries everything on this
...
110 files, 1.6 MB of a 4.72 MB wheel, and the browser payload with Mermaid is
